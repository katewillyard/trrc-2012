## program:             25-findComChar_20170118.py
## task:                Create geodatabase
##                              Dissolve oil wells to oil leases
##                              Make 1 mile buffer around oil leases/ gas wells
##                              Overlay and summarize community characteristics of blockgroups within 1 mile of oil leases/gas wells
##
## version:     First Draft
## project:             Dissertation
## author:              Kate Willyard 1/18/2017
##
...
gdbOld="24-eocpc_20170117.gdb"
gdbNew="25-eocpc_20170118.gdb"
...
for n in range(1,36):
        ...
        if estna == "B15002e1":
                ...
                arcpy.CalculateField_management(newTab, "sumOver25noHSdiploma", calc)
        else:
                delList.append(estna)
stna = "B15003"
for n in range(1,26):
...
##
## Overlay and summarize community characteristics of 
##    blockgroups within 1 mile of oil leases/gas wells
##
arcpy.Intersect_analysis("acs #; gasWells_1miBuf #", "gasCommunities", "ALL", "", "INPUT")
print "done finding gas well communities"
arcpy.Intersect_analysis("acs #; oilLeases_1miBuf #", "oilCommunities", "ALL", "", "INPUT")
print "done finding oil lease communities"
##
## ONCE COMPLETE EXPORT ACS, GASCOMMUNITIES, AND OILCOMMUNITIES ATRRIBUTE TABLES AS TEXT
